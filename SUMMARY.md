  ...
  - [Node](courses/backend/node/README.md)
    ...
    - [Week 2](courses/backend/node/week2/README.md)
      - [Session Materials](courses/backend/node/week2/session-materials/)
        - [REST Principles](courses/backend/node/week2/session-materials/rest-principles-snippets.md)
        - [OpenAPI Basics](courses/backend/node/week2/session-materials/openapi-basics.md)
        - [Validation and error models](courses/backend/node/week2/session-materials/validation-and-error-models.md)
        - [Knex security](courses/backend/node/week2/session-materials/knex-security-snippets.md)
